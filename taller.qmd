...
Consideraciones:
  - Las keywords van en minúsculas y si se componen de más de una palabra llevan espacios entre ellas.
  - Label: Máximo 3 palabras
  - En el json SOLO Y UNICAMENTE debe haber información extraida de la noticia misma y no de las instrucciones de los requisitos de análisis.
...
for (i in nrow(noticias_muestra)){
